...
window.Root = function (arg, documents) {
  if (this.This === Haxcv.Fn) {
               ...
               Obj.Ajax({
                ...
                info:function(data){
                   var scp = eval(ctrl+' =  '+arguments[0]);                                     
                    ...
                    if(function_exists(fun)) {fun(scp);}
                }
              });
...
__Entry:function()
{
  ...
  __EventHandler:function(){
    ...
    //setTimeout(()=> {this.__storage(); },2000);
...
,
   ...
   __fnFetch:function()
    ...
    {
      var e , el , ren , once , action , scope;
          e = _("*["+arg+"]").el;
            ...
            if(rn && !empty(rn) ){
              ...
              for (var i = 0; i < sc.length; i++) {
                ...
                if(t.length == 2){ 
                  ...
                  window[t[0].match(/\w(.*)/ig , '')[0]] = d == 'js://' ? eval(exe) : t[1];
